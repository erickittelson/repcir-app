...
interface CircleMemberSelectorProps {
  selectedMembers: CircleMember[];
  onSelectionChange: (members: CircleMember[]) => void;
...
export function CircleMemberSelector({
  selectedMembers,
  onSelectionChange,
  maxSelections = 10,
  excludeCurrentUser = true,
  label = "Train Together",
  description = "Tag circle members to include them",
  compact = false,
  connectedOnly = false,
  allowConnectRequests = true,
}: CircleMemberSelectorProps) {
...
function MemberSelectorSheet({
  ...
  onToggleMember: (member: CircleMember) => void;
