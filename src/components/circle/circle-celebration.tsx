...
interface CircleCelebrationProps {
  circleName: string;
  circleId: string;
  userAvatar?: string;
  userName: string;
...
export function CircleCelebration({
  circleName,
  circleId: _circleId, // Available for future use (e.g., analytics, navigation)
  userAvatar,
  userName,
  onAnimationComplete,
}: CircleCelebrationProps) {
  // circleId is available via _circleId if needed for tracking or navigation
  void _circleId;
      ...
      <div className="fixed inset-0 z-50 flex items-center justify-center bg-background/95 backdrop-blur-sm">
        <div className="text-center space-y-6 px-6">
          ...
          <div className="flex items-center justify-center gap-2 text-sm text-muted-foreground">
            ...
            <span>You&apos;ve joined the circle</span>
          </div>
        </div>
      </div>
    );
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-background/95 backdrop-blur-sm overflow-hidden">
      ...
      <div className="relative text-center space-y-6 px-6">
        {/* Circle Circle with pulse/burst effect */}
        <div className="relative mx-auto w-32 h-32">
          {/* Glow pulse effect */}
          <motion.div
...
export default CircleCelebration;
